...
define(function (require) {
    ...
    Game.prototype.render = function render() {
        ...
        // Render all souls
        for (i = 0, l = souls.length; i < l; i += 1) {
            souls[i].render(renderAssistant);
        }
    ...
    Game.prototype.setActiveScene = function (scene) {
        ...
        this.scenes[this.activeScene].gui.setVisible(false);
        this.activeScene = scene;
        this.scenes[this.activeScene].gui.setVisible(true);
        this.trigger("enter_scene_" + scene);
    };

    Game.prototype.loadImage = function (id, content, loadedCallback) {
        resourceAssistant.loadImage(id, content, loadedCallback);
    };
