...
define(function (require) {
     ...
     */
    Game.prototype.addBackground = function (name, sceneId, backgroundDesc) {
        this.gui.addElement(sceneId, new GUI.Background(name, backgroundDesc).elem);
    };
     ...
     * @method addiFrame
     */
    Game.prototype.addiFrame = function (name, sceneId, iFrameDesc) {
        this.gui.addElement(sceneId, new GUI.iFrame(name, iFrameDesc).elem);
    };
