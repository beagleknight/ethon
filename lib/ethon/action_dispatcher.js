...
define(function (require) {
    ...
    /**
     * Deregister a callback function saved when clicking the mouse
     */
    function deregisterMouseClickAction(button, quad, callback) {
        eventEmitter.off("mousedown", function (mouse) {
            if (mouse.buttons[inputAssistant.lut[button]]) {
                if (isMouseInsideQuad(quad, mouse)) {
                    callback(normalizeMouse(mouse));
                }
    ...
    return {
        ...
        deregisterMouseClickAction: deregisterMouseClickAction,
