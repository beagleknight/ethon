...
// TODO: require physics assistant
// TODO: require event emitter
// TODO: require Map
// TODO: require GUI
var ethon = ethon || {},
    window = window || {};
            ...
            for (j = 0, ll = this.souls.length; j < ll; j += 1) {
                ...
                if (soul1 !== soul2) {
                    if (physicsAssistant.soulsCollision(soul1, soul2)) {
                        this.trigger("collision_" + soul1.getName() + "_" + soul2.getName());
                        this.trigger("collision_" + soul2.getName() + "_" + soul1.getName());
                    }
                }
            }
