...
(function (window, exports) {
    ...
    require(["./proxy", "./extend", "./request_animation_frame", "./render_assistant",
            "./physics_assistant", "./event_emitter", "./map", "./gui"],
            function (proxy, extend, requestAnimationFrame, renderAssistant,
                physicsAssistant, eventEmitter, Map, GUI) {
