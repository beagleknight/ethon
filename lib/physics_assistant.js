...
(function (window, exports) {
    ...
    function soulsCollision(soul1, soul2) {
        ...
        if (body1 instanceof ethon.CircleBody) {
            if (body2 instanceof ethon.CircleBody) {
                result = circlesCollision(body1, body2);
            } else if (body2 instanceof ethon.QuadBody) {
                result = circleQuadCollision(body1, body2);
            } else {
                throw "TypeError";
            }
        } else if (body1 instanceof ethon.QuadBody) {
            if (body2 instanceof ethon.CircleBody) {
